...
const MONGO_URL = 'mongodb+srv://alnahian66:123123123@cluster0.tczb8ow.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0';

router.get("/hello", (req, res) => res.send("Hello World!"));


// To store incoming product images from frontend
const storage = multer.diskStorage({
    destination: "./public",
    // destination: (req, file, cb) => {
    //     cb(null, 'c:/Users/User/Desktop/khawahobe-main/rest-mng-app-react-be-main/public'); // Set your destination folder
    // },
...
router.post('/products', upload.single('imageFile'), async (req, res) => {
    ...
    try {
        ...
        let imagePath = req.file.filename; // Path to the uploaded file
